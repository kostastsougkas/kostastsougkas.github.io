(function(root,factory){
  ...
  const sub={
    '₀':'0','₁':'1','₂':'2','₃':'3','₄':'4','₅':'5','₆':'6','₇':'7','₈':'8','₉':'9',
    'ₐ':'a','ₑ':'e','ₕ':'h','ᵢ':'i','ⱼ':'j','ₖ':'k','ₗ':'l','ₘ':'m','ₙ':'n','ₒ':'o','ₚ':'p','ᵣ':'r','ₛ':'s','ₜ':'t','ₓ':'x'
  };
  const sup={
    '⁰':'0','¹':'1','²':'2','³':'3','⁴':'4','⁵':'5','⁶':'6','⁷':'7','⁸':'8','⁹':'9',
  ...
  function integral(lower,upper){
    ...
    return '<math class="math-token" aria-label="integral from '+low+' to '+up+'"><msubsup><mo>∫</mo>'+identifier(low)+identifier(up)+'</msubsup></math>';
  }
  ...
  function typeset(value){
    ...
    html=html.replace(/([₀₁₂₃₄₅₆₇₈₉ₐₑₕᵢⱼₖₗₘₙₒₚᵣₛₜₓ]+)/g,value=>'<sub class="math-script">'+decode(value,sub)+'</sub>');
    html=html.replace(/([⁰¹²³⁴⁵⁶⁷⁸⁹⁺⁻⁼⁽⁾ⁿᵃᵇᶜᵈᵉˣ]+)/g,value=>'<sup class="math-script">'+decode(value,sup)+'</sup>');
    html=html.replace(/∫/g,'<math class="math-token"><mo>∫</mo></math>');
    return html;
  }
  return typeset;
});
